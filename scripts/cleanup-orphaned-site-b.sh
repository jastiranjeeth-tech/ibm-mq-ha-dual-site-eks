...
REGION="us-west-2"
VPCS=("vpc-0937623017216bfe5" "vpc-054f0dba7e3c9a0e7" "vpc-06c18093eb7f1081b")

echo "=== Cleaning up orphaned site-b resources ==="
...
IAM_ROLES=$(aws iam list-roles --query 'Roles[?contains(RoleName, `mq-ha-site-b`)].RoleName' --output text)
...
aws logs delete-log-group --region $REGION --log-group-name "/aws/eks/mq-ha-site-b/cluster" 2>/dev/null && echo "  ✅ Deleted log group" || echo "  ℹ️  No log group found"

echo ""
echo "✅ Cleanup complete for site-b!"
